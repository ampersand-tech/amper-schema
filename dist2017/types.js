...
function addType(typeName, caseInsensitive, defaultValue, validateFunc, maxStrLength = 0, toSqlFunc, fromSqlFunc) {
    addSubType(typeName, {
...
function createEnum(enumName, values, nullable = false) {
    nullable = !!nullable;
